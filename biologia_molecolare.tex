...
\item
  ...
  $\alpha$ (attività polimerasica), $\varepsilon$ (esonucleasica
  3'\$\rightarrow$5’) e $\theta\$ (stimolo all'esonucleasi);
\item
...
ciascuna origine un \textbf{complesso di pre-replicazione (pre-RC)}. Il
costituente principale del pre-RC è il complesso ORC. Il complesso
