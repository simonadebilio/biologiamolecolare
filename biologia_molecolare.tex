...
i 9 nt di lunghezza. Questa sintesi abortiva è ripetuta più volte fino a
quando, superata la lunghezza di 9 nt, si forma un ibrido DNA-RNA
sufficientemente stabile. La polimerasi può a questo punto rilasciare il
promotore e proseguire nella fase di allungamento.
...
Se viene incorporato un nucleotide non corretto, l'appaiamento di basi
nella bolla risulterà anomalo e questo indurrà la polimerasi a tornare
indietro e a eliminare il nucleotide sbagliato con un meccanismo di
correzione.
...
\paragraph{I promotori e il fattore
sigma}\label{i-promotori-e-il-fattore-sigma}
