...
\item
  ...
  ligati in un vettore. E' un metodo relativamente semplice, anche se la
...
E' inoltre, necessaria l'introduzione di \textbf{sistemi REPORTER} sia
esogeni che endogeni per identificare l'effettivo trasporto del farmaco
all'interno delle cellule. E' fondamentale, infine, rispettare i
